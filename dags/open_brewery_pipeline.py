...
from scripts.fetch_data_bronze import fetch_and_save_breweries_to_bronze
...
def open_brewery_data_pipeline():
    ...
    transform_to_silver_task = SparkSubmitOperator(
        ...
        py_files='/opt/airflow/dags/utils/text_processing.py,/opt/airflow/dags/queries/silver/breweries/queries_silver_breweries.py',
